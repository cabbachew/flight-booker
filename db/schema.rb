...
ActiveRecord::Schema[7.0].define(version: 2022_11_27_043507) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["flight_id", "passenger_id"], name: "index_bookings_on_flight_id_and_passenger_id", unique: true
